ARG SEAWEED_VERSION=4.19

FROM registry.access.redhat.com/ubi9/ubi:9.7-1778461714 AS builder
ARG SEAWEED_VERSION
...
FROM registry.access.redhat.com/ubi9/ubi-micro:9.7-1778461406
ARG SEAWEED_VERSION
