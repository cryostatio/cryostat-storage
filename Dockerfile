ARG SEAWEED_VERSION=4.46

FROM registry.access.redhat.com/ubi9/ubi:9.8-1788939089@sha256:206b65b8ee0f04b992818c9a51b29081b14974630d4850bc358097d0c44ea156 AS builder
ARG SEAWEED_VERSION
